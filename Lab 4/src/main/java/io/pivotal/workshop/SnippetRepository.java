...
public class SnippetRepository {
    ...
    private final String SQL_QUERY_CREATION_BETWEEN_DATES = "select * from snippet where created BETWEEN %s AND %s";

    public List<SnippetRecord> findBetweenCreationDates(String firstDate, String secondDate) {
        String finalQuery = String.format(SQL_QUERY_CREATION_BETWEEN_DATES, firstDate, secondDate);
