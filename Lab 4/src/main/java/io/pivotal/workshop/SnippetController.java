...
public class SnippetController {
    ...
    @GetMapping
    public List<SnippetInfo> snippets(@RequestParam(value = "firstDate", required = false) String firstDate, @RequestParam(value = "secondDate", required = false) String secondDate) {
        if (firstDate != null && secondDate != null) {
            return snippetRepository.findBetweenCreationDates(firstDate, secondDate)
                    .stream()
